 ...
 * XML source: C:/Users/Philip/Documents/Academic/workspace/uimaFIT-examples/src/main/resources/org/uimafit/examples/TypeSystem.xml
 * @generated */
public class Meeting extends Annotation {
  ...
  public RoomNumber getRoom() {
    if (Meeting_Type.featOkTst && ((Meeting_Type)jcasType).casFeat_room == null)
      jcasType.jcas.throwFeatMissing("room", "org.uimafit.examples.tutorial.type.Meeting");
  ...
  public DateAnnotation getDate() {
    if (Meeting_Type.featOkTst && ((Meeting_Type)jcasType).casFeat_date == null)
      jcasType.jcas.throwFeatMissing("date", "org.uimafit.examples.tutorial.type.Meeting");
  ...
  public TimeAnnotation getStartTime() {
    if (Meeting_Type.featOkTst && ((Meeting_Type)jcasType).casFeat_startTime == null)
      jcasType.jcas.throwFeatMissing("startTime", "org.uimafit.examples.tutorial.type.Meeting");
    return (TimeAnnotation)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Meeting_Type)jcasType).casFeatCode_startTime)));}
  ...
  public TimeAnnotation getEndTime() {
    if (Meeting_Type.featOkTst && ((Meeting_Type)jcasType).casFeat_endTime == null)
      jcasType.jcas.throwFeatMissing("endTime", "org.uimafit.examples.tutorial.type.Meeting");
