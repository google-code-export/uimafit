...
public class GetStartedQuickPipeline {
	...
	public static void main(String[] args) throws UIMAException {
		...
		// system types here or provide the name of your type system (e.g.
		...
		// uimaFIT doesn't provide any collection readers - so we will just
		// instantiate a JCas and run it through our AE
		...
		AnalysisEngine analysisEngine = AnalysisEngineFactory.createPrimitive(GetStartedQuickAE.class, typeSystemDescription, "stringParamName",
				"uimaFIT");
		// run the analysis engine and look for a special greeting in your
		// console.
