...
public class Meeting_Type extends Annotation_Type {
  ...
  public int getRoom(int addr) {
      ...
      jcas.throwFeatMissing("room", "org.uimafit.examples.tutorial.type.Meeting");
  ...
  public int getDate(int addr) {
      ...
      jcas.throwFeatMissing("date", "org.uimafit.examples.tutorial.type.Meeting");
  ...
  public int getStartTime(int addr) {
      ...
      jcas.throwFeatMissing("startTime", "org.uimafit.examples.tutorial.type.Meeting");
  ...
  public int getEndTime(int addr) {
      ...
      jcas.throwFeatMissing("endTime", "org.uimafit.examples.tutorial.type.Meeting");
