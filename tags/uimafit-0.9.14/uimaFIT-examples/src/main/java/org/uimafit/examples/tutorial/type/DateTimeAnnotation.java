...
public class DateTimeAnnotation extends Annotation {
  ...
  public String getShortDateString() {
    if (DateTimeAnnotation_Type.featOkTst && ((DateTimeAnnotation_Type)jcasType).casFeat_shortDateString == null)
      jcasType.jcas.throwFeatMissing("shortDateString", "org.uimafit.examples.tutorial.type.DateTimeAnnotation");
