...
public class RoomNumber_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.uutuc.tutorial.type.RoomNumber");
  ...
  public String getBuilding(int addr) {
      ...
      jcas.throwFeatMissing("building", "org.uutuc.tutorial.type.RoomNumber");
