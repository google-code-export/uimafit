...
package org.uimafit.tutorial.ex6;
...
import org.uimafit.tutorial.type.Meeting;
import org.uimafit.tutorial.type.UimaMeeting;
...
public class UimaMeetingAnnotator extends JCasAnnotator_ImplBase {
  ...
  public static void main(String[] args) throws Exception {
		...
		AnalysisEngineDescription aed = AnalysisEngineFactory.createPrimitiveDescription(UimaMeetingAnnotator.class, tsd);
		
		aed.toXML(new FileOutputStream(new File(outputDirectory, "UimaMeetingAnnotator.xml")));

		AggregateBuilder builder = new AggregateBuilder();
		builder.add(AnalysisEngineFactory.createAnalysisEngineDescription("org.uimafit.tutorial.ex6.UimaAcronymAnnotator"));
