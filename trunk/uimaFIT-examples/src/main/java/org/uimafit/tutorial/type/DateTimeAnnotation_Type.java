...
public class DateTimeAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.uimafit.tutorial.type.DateTimeAnnotation");
  ...
  public String getShortDateString(int addr) {
      ...
      jcas.throwFeatMissing("shortDateString", "org.uimafit.tutorial.type.DateTimeAnnotation");
