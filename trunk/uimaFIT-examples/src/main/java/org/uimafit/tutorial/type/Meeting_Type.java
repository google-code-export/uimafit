...
public class Meeting_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.uimafit.tutorial.type.Meeting");
  ...
  public int getRoom(int addr) {
      ...
      jcas.throwFeatMissing("room", "org.uimafit.tutorial.type.Meeting");
  ...
  public int getDate(int addr) {
      ...
      jcas.throwFeatMissing("date", "org.uimafit.tutorial.type.Meeting");
  ...
  public int getStartTime(int addr) {
      ...
      jcas.throwFeatMissing("startTime", "org.uimafit.tutorial.type.Meeting");
  ...
  public int getEndTime(int addr) {
      ...
      jcas.throwFeatMissing("endTime", "org.uimafit.tutorial.type.Meeting");
  ...
  public Meeting_Type(JCas jcas, Type casType) {
    ...
    casFeat_room = jcas.getRequiredFeatureDE(casType, "room", "org.uimafit.tutorial.type.RoomNumber", featOkTst);
    casFeatCode_room  = (null == casFeat_room) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_room).getCode();

 
    casFeat_date = jcas.getRequiredFeatureDE(casType, "date", "org.uimafit.tutorial.type.DateAnnotation", featOkTst);
    casFeatCode_date  = (null == casFeat_date) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_date).getCode();

 
    casFeat_startTime = jcas.getRequiredFeatureDE(casType, "startTime", "org.uimafit.tutorial.type.TimeAnnotation", featOkTst);
    casFeatCode_startTime  = (null == casFeat_startTime) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_startTime).getCode();

 
    casFeat_endTime = jcas.getRequiredFeatureDE(casType, "endTime", "org.uimafit.tutorial.type.TimeAnnotation", featOkTst);
