...
public class UimaMeetingAnnotator extends JCasAnnotator_ImplBase {
  ...
  public static void main(String[] args) throws Exception {
		...
		builder.add(AnalysisEngineFactory.createAnalysisEngineDescription("org.uutuc.tutorial.ex6.UimaAcronymAnnotator"));
		builder.add(AnalysisEngineFactory.createAnalysisEngineDescription("org.uutuc.tutorial.ex6.UimaMeetingAnnotator"));
