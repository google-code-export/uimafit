...
public class UimaAcronym_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.uutuc.tutorial.type.UimaAcronym");
  ...
  public String getExpandedForm(int addr) {
      ...
      jcas.throwFeatMissing("expandedForm", "org.uutuc.tutorial.type.UimaAcronym");
